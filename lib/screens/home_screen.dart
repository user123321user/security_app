...
import 'logs_screen.dart'; // أضف هذا الاستيراد في أعلى الملف تماماً مع باقي الشاشات
        ...
        child: Column(
          children: [
            ...
            _buildDashboardCard(
              ...
              color: Colors.teal,
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => UsersScreen(isArabic: _isArabic)));
              },
            ),
            const SizedBox(height: 12),
            _buildDashboardCard(
            ...
            _buildDashboardCard(
              ...
              color: Colors.purple,
              onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => AnalyticsScreen(isArabic: _isArabic))),
            ),
            // [جديد]: البطاقة الخامسة المخصصة لتوجه المدير إلى سجل العمليات والنشاطات السحابي
            const SizedBox(height: 12),
            _buildDashboardCard(
              icon: Icons.history,
              title: _isArabic ? 'سجل العمليات والنشاطات السحابي' : 'System Activity Logs',
              subtitle: _isArabic
                  ? 'تتبع عمليات المسؤولين والموظفين والتحركات المالية لحظياً بالوقت والتاريخ'
                  : 'Track admin & employee operations and financial movements in real-time',
              color: Colors.brown,
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => LogsScreen(isArabic: _isArabic)) // تمرير حالة اللغة النشطة وثابتة
                );
              },
            ),
