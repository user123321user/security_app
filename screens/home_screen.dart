        ...
        child: Column(
          children: [
            ...
            _buildDashboardCard(
              ...
              title: 'استعراض عقودي الأمنية وأرشفة الـ PDF',
              subtitle: 'الوصول السريع والآمن للعقود الرقمية والاتفاقيات الموقعة معنا',
              color: Colors.redAccent,
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => ContractsScreen(userRole: 'client', currentUserName: name)) // العميل يرى عقوده فقط بالاسم الصريح
                );
              },
            ),
