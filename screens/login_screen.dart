...
class _LoginScreenState extends State<LoginScreen> {
  ...
  bool _isArabic = true; // الحالة اللغوية الافتراضية لشاشة الدخول

  @override
  void initState() {
    super.initState();
    _loadSavedLanguage(); // قراءة اللغة المحفوظة في قرص الهاتف فور فتح الشاشة
  }
  ...
  // قراءة اللغة المخزنة في الهاتف لتوحيد بيئة التطبيق
  ...
  // تبديل اللغة وحفظها في القرص الصلب ليتذكرها النظام عند إعادة التشغيل
  ...
  Widget build(BuildContext context) {
    // تغليف واجهة الدخول بموجه الاتجاه لتقلب حقول الإدخال والأزرار تلقائياً (RTL / LTR)
    return Directionality(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          actions: [
            // زر التبديل اللغوي الذكي في شاشة تسجيل الدخول
            TextButton.icon(
        ...
        body: Center(
          child: SingleChildScrollView(
            ...
            child: Column(
              mainAxisAlignment: CenterMainAxisAlignment.center,
              children: [
                ...
                ElevatedButton(
                  ...
                  child: _isLoading
                      ...
                      : Text(
                    _isArabic ? 'ولوج آمن للمنظومة' : 'Secure Secure Login',
