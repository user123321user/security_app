...
class _ContractsScreenState extends State<ContractsScreen> {
  ...
  final _searchController = TextEditingController(); // متحكم شريط البحث الجديد
  String _selectedPaymentStatus = 'قيد الانتظار';
  String _searchQuery = ''; // متغير لتخزين نص البحث الحالي
  ...
  Future<void> _saveContract() async {
    ...
    final String currentAdminEmail = FirebaseAuth.instance.currentUser?.email ?? 'المسؤول المالي';
  ...
  Future<void> _togglePaymentStatus(String docId, String currentStatus) async {
    ...
    try {
      ...
      await AppLogger.logActivity(
        ...
        userEmail: FirebaseAuth.instance.currentUser?.email ?? 'الإدارة المالية',
      );
    } catch (e) {
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            // [جديد]: شريط البحث المتقدم والفلترة الفورية للعقود والفواتير
            TextField(
