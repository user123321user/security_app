...
class _EmployeesScreenState extends State<EmployeesScreen> {
  ...
  // 1. [عملية الإضافة]: حفظ نوبة حارس جديد سحابياً
  Future<void> _saveEmployee() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        );      // [المكان الدقيق]: ضع هذا السطر داخل بلوك try عند نجاح الحفظ وقبل تفريغ الحقول
        await AppLogger.logActivity(
          ...
          userEmail: FirebaseAuth.instance.currentUser?.email ?? 'مسؤول النوبات',
        );
  ...
  // 3. [عملية الحذف]: دالة مسح النوبة بعد انتهائها من الأرشيف السحابي
  ...
  // نافذة منبثقة لتعديل بيانات الهاتف والموقع الميداني للحارس UI/UX
              ...
              builder: (context, snapshot) {
                if (!snapshot.hasData) {
                  return DropdownButtonFormField(
                    items: [],
                    onChanged: null,
                    decoration: InputDecoration(labelText: 'جاري تحميل قائمة الحراس...', border: OutlineInputBorder()),
                  );
                }
                ...
                return DropdownButtonFormField<String>(
                  ...
                  onChanged: (value) {
                    setState(() { _selectedEmployeeName = value; });
                  },
                );
              },
            ),
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                ...
                builder: (context, snapshot) {
                  ...
                  if (docs.isEmpty) return const Center(child: Text('لا توجد نوبات عمل مسجلة حالياً.'));
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          isThreeLine: true,
                          // إضافة أزرار التحكم (التعديل والحذف المنتهي) لتعزيز الأتمتة الميدانية
                          trailing: Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              IconButton(
