...
class _UsersScreenState extends State<UsersScreen> {
  ...
  Future<void> _createUserAccount() async {
    ...
    // تثبيت بريد المدير المتصل حالياً في أول الدالة قبل الدخول في الجلسة المعزولة
    ...
    try {
      ...
      // تسجيل نشاط الإضافة الناجحة في الحالة العادية
      ...
      if (e.toString().contains('PigeonUserDetails')) {
        ...
        // تسجيل نشاط الإضافة الناجحة عند التقاط استثناء الحزمة الداخلي
        await AppLogger.logActivity(
          action: 'إنشاء حساب جديد',
          details: 'تم إنشاء حساب للمسجل: ${_nameController.text.trim()} بصلاحية: $_selectedRole',
          userEmail: currentAdminEmail,
